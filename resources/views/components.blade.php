...
<head>
	...
	<title>Components — Red Parts</title>
...
<body>
	...
	C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z" /></svg> <span
											class="mobile-indicator__counter">3</span></span></a></div>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="topbar topbar--spaceship-end">
						...
						<div class="topbar__item-button topbar__menu"><button
								class="topbar__button topbar__button--has-arrow topbar__menu-button" type="button"><span
									class="topbar__button-label">Currency:</span> <span class="topbar__button-title">USD</span> <span
						...
						<div class="topbar__menu"><button class="topbar__button topbar__button--has-arrow topbar__menu-button"
								type="button"><span class="topbar__button-label">Language:</span> <span
									class="topbar__button-title">EN</span> <span class="topbar__button-arrow"><svg width="7px"
										height="5px">
										<path
											d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z" />
										</svg></span></button>
							<div class="topbar__menu-body"><a class="topbar__menu-item" href="#"><img
									...
									class="topbar__menu-item" href="#"><img src="images/languages/language-3.png"
										alt=""><span>German</span> </a><a class="topbar__menu-item" href="#"><img
										src="images/languages/language-4.png" alt=""><span>Russian</span> </a><a class="topbar__menu-item"
									href="#"><img src="images/languages/language-5.png" alt=""><span>Italian</span></a></div>
						</div>
					</div>
				</div>
				<div class="header__navbar">
					<div class="header__navbar-departments">
						<div class="departments"><button class="departments__button" type="button"><span
								...
								</span><span class="departments__button-title">Menu</span> <span class="departments__button-arrow"><svg
							...
							<div class="departments__menu">
								...
								<div class="departments__body">
									<ul class="departments__list">
										...
										<li class="departments__item departments__item--submenu--megamenu departments__item--has-submenu"><a
												href="#" class="departments__item-link">Headlights & Lighting <span
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" /></svg></span></a>
													...
													<div class="row">
														<div class="col-1of5">
															<ul class="megamenu__links megamenu-links megamenu-links--root">
																<li class="megamenu-links__item megamenu-links__item--has-submenu"><a
																		class="megamenu-links__item-link" href="#">Body Parts</a>
																	<ul class="megamenu-links">
																		...
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link"
																				href="#">Grilles</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Fog
																				Lights</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Door
																				Handles</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Car
																				Covers</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link"
																				href="#">Tailgates</a></li>
																	</ul>
														...
														<div class="col-1of5">
															<ul class="megamenu__links megamenu-links megamenu-links--root">
																<li class="megamenu-links__item megamenu-links__item--has-submenu"><a
																		class="megamenu-links__item-link" href="#">Headlights & Lighting</a>
																	<ul class="megamenu-links">
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link"
																				href="#">Headlights</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Tail
																				Lights</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Fog
																				Lights</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Turn
																				Signals</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link"
																...
																<li class="megamenu-links__item megamenu-links__item--has-submenu"><a
																		class="megamenu-links__item-link" href="#">Brakes & Suspension</a>
																	<ul class="megamenu-links">
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Brake
																				Discs</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Wheel
																				Hubs</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Air
																				Suspension</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Ball
																				Joints</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Brake
																				Pad Sets</a></li>
																	</ul>
														...
														<div class="col-1of5">
															<ul class="megamenu__links megamenu-links megamenu-links--root">
																<li class="megamenu-links__item megamenu-links__item--has-submenu"><a
																		class="megamenu-links__item-link" href="#">Interior Parts</a>
																	<ul class="megamenu-links">
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Floor
																				Mats</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link"
																				href="#">Gauges</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link"
																		...
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Cargo
																				Accessories</a></li>
																	</ul>
																</li>
																<li class="megamenu-links__item megamenu-links__item--has-submenu"><a
																		class="megamenu-links__item-link" href="#">Engine & Drivetrain</a>
																	<ul class="megamenu-links">
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Air
																				Filters</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link"
														...
														<div class="col-1of5">
															<ul class="megamenu__links megamenu-links megamenu-links--root">
																<li class="megamenu-links__item megamenu-links__item--has-submenu"><a
																		class="megamenu-links__item-link" href="#">Tools & Garage</a>
																	<ul class="megamenu-links">
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link"
																				href="#">Repair Manuals</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Car
																				Care</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Code
																				Readers</a></li>
																		<li class="megamenu-links__item"><a class="megamenu-links__item-link" href="#">Tool
																				Boxes</a></li>
																	</ul>
																</li>
															</ul>
										...
										<li class="departments__item departments__item--submenu--megamenu departments__item--has-submenu"><a
												href="#" class="departments__item-link">Interior Parts <span
													class="departments__item-arrow"><svg width="7" height="11">
														<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" /></svg></span></a>
											<div class="departments__item-menu">
										...
										<li class="departments__item departments__item--submenu--megamenu departments__item--has-submenu"><a
												href="#" class="departments__item-link">Switches & Relays <span
													class="departments__item-arrow"><svg width="7" height="11">
														<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" /></svg></span></a>
											<div class="departments__item-menu">
										...
										<li class="departments__item departments__item--submenu--megamenu departments__item--has-submenu"><a
												href="#" class="departments__item-link">Tires & Wheels <span
													class="departments__item-arrow"><svg width="7" height="11">
														<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" /></svg></span></a>
											<div class="departments__item-menu">
										...
										<li class="departments__item departments__item--submenu--megamenu departments__item--has-submenu"><a
												href="#" class="departments__item-link">Tools & Garage <span
													class="departments__item-arrow"><svg width="7" height="11">
														<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" /></svg></span></a>
											<div class="departments__item-menu">
								...
								<li class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu"><a
									...
									<div class="main-menu__submenu">
										<ul class="menu">
											...
											<li class="menu__item menu__item--has-submenu"><a href="header-spaceship-variant-one.html"
												...
												<div class="menu__submenu">
													<ul class="menu">
														...
														<li class="menu__item"><a href="header-spaceship-variant-two.html"
																class="menu__link">Variant Two</a></li>
														<li class="menu__item"><a href="header-spaceship-variant-three.html"
																class="menu__link">Variant Three</a></li>
													</ul>
												</div>
											</li>
											<li class="menu__item menu__item--has-submenu"><a href="header-classic-variant-one.html"
												...
												<div class="menu__submenu">
													<ul class="menu">
														<li class="menu__item"><a href="header-classic-variant-one.html" class="menu__link">Variant
																One</a></li>
														<li class="menu__item"><a href="header-classic-variant-two.html" class="menu__link">Variant
																Two</a></li>
														<li class="menu__item"><a href="header-classic-variant-three.html"
																class="menu__link">Variant Three</a></li>
														<li class="menu__item"><a href="header-classic-variant-four.html" class="menu__link">Variant
																Four</a></li>
														<li class="menu__item"><a href="header-classic-variant-five.html" class="menu__link">Variant
																Five</a></li>
													</ul>
												</div>
											</li>
											<li class="menu__item menu__item--has-submenu"><a href="mobile-header-variant-one.html"
												...
												<div class="menu__submenu">
													<ul class="menu">
														<li class="menu__item"><a href="mobile-header-variant-one.html" class="menu__link">Variant
																One</a></li>
														<li class="menu__item"><a href="mobile-header-variant-two.html" class="menu__link">Variant
																Two</a></li>
													</ul>
												</div>
											</li>
											...
											<li class="menu__item menu__item--has-submenu"><a href="product-full.html"
												...
												<div class="menu__submenu">
													<ul class="menu">
														...
														<li class="menu__item"><a href="product-sidebar.html" class="menu__link">Left Sidebar</a>
														</li>
													</ul>
												</div>
											</li>
								...
								<li class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu"><a
									...
									<div class="main-menu__submenu">
										<ul class="menu">
											...
											<li class="menu__item menu__item--has-submenu"><a href="blog-list-right-sidebar.html"
												...
												<div class="menu__submenu">
													<ul class="menu">
														<li class="menu__item"><a href="blog-list-left-sidebar.html" class="menu__link">Left
																Sidebar</a></li>
														<li class="menu__item"><a href="blog-list-right-sidebar.html" class="menu__link">Right
																Sidebar</a></li>
													</ul>
												</div>
											</li>
											<li class="menu__item menu__item--has-submenu"><a href="blog-grid-right-sidebar.html"
												...
												<div class="menu__submenu">
													<ul class="menu">
														<li class="menu__item"><a href="blog-grid-left-sidebar.html" class="menu__link">Left
																Sidebar</a></li>
														<li class="menu__item"><a href="blog-grid-right-sidebar.html" class="menu__link">Right
																Sidebar</a></li>
													</ul>
												</div>
											</li>
											...
											<li class="menu__item"><a href="post-without-image.html" class="menu__link">Post Without Image</a>
											</li>
										</ul>
									</div>
								</li>
					...
					<div class="search">
						<form action="#" class="search__body">
							<div class="search__shadow"></div><input class="search__input" type="text"
								placeholder="Enter Keyword or Part Number"> <button class="search__button search__button--start"
	...
	c4,0,5.4-0.6,6.3-1c0.2-0.1,0.2-0.8,0-1.2c-0.2-0.4-0.5-1.5-1-2C14.7,4,14.1,4,13.3,4z M4,10c-0.4-0.3-1.5-0.5-2,0
	c-0.4,0.4-0.4,1.6,0,2c0.5,0.5,4,0.4,4,0C6,11.2,4.5,10.3,4,10z M14,12c0,0.4,3.5,0.5,4,0c0.4-0.4,0.4-1.6,0-2c-0.5-0.5-1.3-0.3-2,0
	C15.5,10.2,14,11.3,14,12z" /></svg> </span><span class="search__button-title">Select Vehicle</span></button> <button
								class="search__button search__button--end" type="submit"><span class="search__button-icon"><svg
										width="20" height="20">
										<path d="M19.2,17.8c0,0-0.2,0.5-0.5,0.8c-0.4,0.4-0.9,0.6-0.9,0.6s-0.9,0.7-2.8-1.6c-1.1-1.4-2.2-2.8-3.1-3.9C10.9,14.5,9.5,15,8,15
	c-3.9,0-7-3.1-7-7s3.1-7,7-7s7,3.1,7,7c0,1.5-0.5,2.9-1.3,4c1.1,0.8,2.5,2,4,3.1C20,16.8,19.2,17.8,19.2,17.8z M8,3C5.2,3,3,5.2,3,8
							...
							<div class="search__dropdown search__dropdown--suggestions suggestions">
								<div class="suggestions__group">
									...
									<div class="suggestions__group-content"><a class="suggestions__item suggestions__product" href="#">
											<div class="suggestions__product-image"><img src="images/products/product-2-40x40.jpg" alt="">
											</div>
											...
											<div class="suggestions__product-image"><img src="images/products/product-3-40x40.jpg" alt="">
											</div>
											<div class="suggestions__product-info">
											...
											<div class="suggestions__product-image"><img src="images/products/product-4-40x40.jpg" alt="">
											</div>
											<div class="suggestions__product-info">
								...
								<div class="suggestions__group">
									...
									<div class="suggestions__group-content"><a class="suggestions__item suggestions__category"
											href="#">Headlights & Lighting</a> <a class="suggestions__item suggestions__category"
											href="#">Fuel System & Filters</a> <a class="suggestions__item suggestions__category"
											href="#">Body Parts & Mirrors</a> <a class="suggestions__item suggestions__category"
			...
			<div class="block-header block-header--has-breadcrumb block-header--has-title">
				<div class="container">
					<div class="block-header__body">
						...
						<h1 class="block-header__title">Components</h1>
					</div>
				</div>
			</div>
			<div class="block">
				<div class="container">
					<div class="card mb-4">
						<div class="card-body card-body--padding--2">
							...
							<div class="row">
								<div class="col-12">
									<div class="alert alert-primary alert-lg mb-3 alert-dismissible fade show">A simple large alert with
										<a href="#">an example link</a>. Give it a click if you like. <button type="button" class="close"
											data-dismiss="alert" aria-label="Close"><svg width="12" height="12">
												<path d="M10.8,10.8L10.8,10.8c-0.4,0.4-1,0.4-1.4,0L6,7.4l-3.4,3.4c-0.4,0.4-1,0.4-1.4,0l0,0c-0.4-0.4-0.4-1,0-1.4L4.6,6L1.2,2.6
	c-0.4-0.4-0.4-1,0-1.4l0,0c0.4-0.4,1-0.4,1.4,0L6,4.6l3.4-3.4c0.4-0.4,1-0.4,1.4,0l0,0c0.4,0.4,0.4,1,0,1.4L7.4,6l3.4,3.4
	C11.2,9.8,11.2,10.4,10.8,10.8z" /></svg></button></div>
								</div>
								<div class="col-12 col-md-6">
									<div class="alert alert-info mb-3">A simple alert with <a href="#">an example link</a>. Give it a
										click if you like.</div>
									<div class="alert alert-primary mb-3">A simple alert with <a href="#">an example link</a>. Give it a
										click if you like.</div>
									<div class="alert alert-secondary mb-3 mb-md-5">A simple alert with <a href="#">an example link</a>.
										Give it a click if you like.</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="alert alert-success mb-3">A simple alert with <a href="#">an example link</a>. Give it a
										click if you like.</div>
									<div class="alert alert-danger mb-3">A simple alert with <a href="#">an example link</a>. Give it a
										click if you like.</div>
									<div class="alert alert-warning mb-5">A simple alert with <a href="#">an example link</a>. Give it a
										click if you like.</div>
								</div>
							</div>
					...
					<div class="card mb-4">
						<div class="card-body card-body--padding--2">
							<h2 class="card-title">Input Number</h2>
							<div class="row">
								<div class="col-3">
									<div class="input-number mb-3"><input class="form-control form-control-lg input-number__input"
											type="number" min="1" value="3">
										<div class="input-number__add"></div>
										<div class="input-number__sub"></div>
									</div>
									<div class="input-number mb-3"><input class="form-control input-number__input" type="number" min="1"
											value="3">
										<div class="input-number__add"></div>
										<div class="input-number__sub"></div>
									</div>
									<div class="input-number"><input class="form-control form-control-sm input-number__input"
											type="number" min="1" value="3">
										<div class="input-number__add"></div>
										<div class="input-number__sub"></div>
									</div>
						...
						<div class="card-body card-body--padding--2">
							...
							<div class="row">
								<div class="col-lg-4">
									...
									<div class="form-group"><button class="btn btn-primary btn-xl">Extra Large</button> <button
											class="btn btn-primary btn-xl btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-primary btn-lg">Button Large</button> <button
											class="btn btn-primary btn-lg btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-primary">Button Normal</button> <button
											class="btn btn-primary btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-primary btn-sm">Button Small</button> <button
											class="btn btn-primary btn-sm btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-primary btn-xs">Extra Small</button> <button
											class="btn btn-primary btn-xs btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<p><strong>Loading State</strong></p>
									<div class="form-group"><button class="btn btn-primary btn-loading btn-xl">Extra Large</button>
										<button class="btn btn-primary btn-loading btn-xl btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-primary btn-loading btn-lg">Button Large</button>
										<button class="btn btn-primary btn-loading btn-lg btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-primary btn-loading">Button Normal</button> <button
											class="btn btn-primary btn-loading btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-primary btn-loading btn-sm">Button Small</button>
										<button class="btn btn-primary btn-loading btn-sm btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-primary btn-loading btn-xs">Extra Small</button>
										<button class="btn btn-primary btn-loading btn-xs btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<p><strong>Disabled State</strong></p>
									<div class="form-group"><button class="btn btn-primary btn-lg" disabled="disabled">Button
											Large</button> <button class="btn btn-primary btn-lg btn-icon" disabled="disabled"><svg width="16"
												height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-primary" disabled="disabled">Button Normal</button>
										<button class="btn btn-primary btn-icon" disabled="disabled"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-primary btn-sm" disabled="disabled">Button
											Small</button> <button class="btn btn-primary btn-sm btn-icon" disabled="disabled"><svg width="16"
												height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-primary btn-xs" disabled="disabled">Extra
											Small</button> <button class="btn btn-primary btn-xs btn-icon" disabled="disabled"><svg width="16"
												height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
								</div>
								<div class="col-lg-4">
									...
									<div class="form-group"><button class="btn btn-secondary btn-xl">Extra Large</button> <button
											class="btn btn-secondary btn-xl btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-secondary btn-lg">Button Large</button> <button
											class="btn btn-secondary btn-lg btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-secondary">Button Normal</button> <button
											class="btn btn-secondary btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-secondary btn-sm">Button Small</button> <button
											class="btn btn-secondary btn-sm btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-secondary btn-xs">Extra Small</button> <button
											class="btn btn-secondary btn-xs btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<p><strong>Loading State</strong></p>
									<div class="form-group"><button class="btn btn-secondary btn-loading btn-xl">Extra Large</button>
										<button class="btn btn-secondary btn-loading btn-xl btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-secondary btn-loading btn-lg">Button Large</button>
										<button class="btn btn-secondary btn-loading btn-lg btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-secondary btn-loading">Button Normal</button> <button
											class="btn btn-secondary btn-loading btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-secondary btn-loading btn-sm">Button Small</button>
										<button class="btn btn-secondary btn-loading btn-sm btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-secondary btn-loading btn-xs">Extra Small</button>
										<button class="btn btn-secondary btn-loading btn-xs btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<p><strong>Disabled State</strong></p>
									<div class="form-group"><button class="btn btn-secondary btn-lg" disabled="disabled">Button
											Large</button> <button class="btn btn-secondary btn-lg btn-icon" disabled="disabled"><svg
												width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-secondary" disabled="disabled">Button Normal</button>
										<button class="btn btn-secondary btn-icon" disabled="disabled"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-secondary btn-sm" disabled="disabled">Button
											Small</button> <button class="btn btn-secondary btn-sm btn-icon" disabled="disabled"><svg
												width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-secondary btn-xs" disabled="disabled">Extra
											Small</button> <button class="btn btn-secondary btn-xs btn-icon" disabled="disabled"><svg
												width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
								</div>
								<div class="col-lg-4">
									...
									<div class="form-group"><button class="btn btn-light btn-xl">Extra Large</button> <button
											class="btn btn-light btn-xl btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-light btn-lg">Button Large</button> <button
											class="btn btn-light btn-lg btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-light">Button Normal</button> <button
											class="btn btn-light btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-light btn-sm">Button Small</button> <button
											class="btn btn-light btn-sm btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-light btn-xs">Extra Small</button> <button
											class="btn btn-light btn-xs btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<p><strong>Loading State</strong></p>
									<div class="form-group"><button class="btn btn-light btn-loading btn-xl">Extra Large</button> <button
											class="btn btn-light btn-loading btn-xl btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-light btn-loading btn-lg">Button Large</button> <button
											class="btn btn-light btn-loading btn-lg btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-light btn-loading">Button Normal</button> <button
											class="btn btn-light btn-loading btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-light btn-loading btn-sm">Button Small</button> <button
											class="btn btn-light btn-loading btn-sm btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-light btn-loading btn-xs">Extra Small</button> <button
											class="btn btn-light btn-loading btn-xs btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<p><strong>Disabled State</strong></p>
									<div class="form-group"><button class="btn btn-light btn-lg" disabled="disabled">Button Large</button>
										<button class="btn btn-light btn-lg btn-icon" disabled="disabled"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-light" disabled="disabled">Button Normal</button>
										<button class="btn btn-light btn-icon" disabled="disabled"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-light btn-sm" disabled="disabled">Button Small</button>
										<button class="btn btn-light btn-sm btn-icon" disabled="disabled"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-light btn-xs" disabled="disabled">Extra Small</button>
										<button class="btn btn-light btn-xs btn-icon" disabled="disabled"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
								</div>
								<div class="col-lg-4">
									<p><strong>Muted Buttons</strong></p>
									<div class="form-group"><button class="btn btn-muted btn-xl">Extra Large</button> <button
											class="btn btn-muted btn-xl btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-muted btn-lg">Button Large</button> <button
											class="btn btn-muted btn-lg btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-muted">Button Normal</button> <button
											class="btn btn-muted btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-muted btn-sm">Button Small</button> <button
											class="btn btn-muted btn-sm btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-muted btn-xs">Extra Small</button> <button
											class="btn btn-muted btn-xs btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<p><strong>Loading State</strong></p>
									<div class="form-group"><button class="btn btn-muted btn-loading btn-xl">Extra Large</button> <button
											class="btn btn-muted btn-loading btn-xl btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-muted btn-loading btn-lg">Button Large</button> <button
											class="btn btn-muted btn-loading btn-lg btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-muted btn-loading">Button Normal</button> <button
											class="btn btn-muted btn-loading btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-muted btn-loading btn-sm">Button Small</button> <button
											class="btn btn-muted btn-loading btn-sm btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-muted btn-loading btn-xs">Extra Small</button> <button
											class="btn btn-muted btn-loading btn-xs btn-icon"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<p><strong>Disabled State</strong></p>
									<div class="form-group"><button class="btn btn-muted btn-lg" disabled="disabled">Button Large</button>
										<button class="btn btn-muted btn-lg btn-icon" disabled="disabled"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-muted" disabled="disabled">Button Normal</button>
										<button class="btn btn-muted btn-icon" disabled="disabled"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-muted btn-sm" disabled="disabled">Button Small</button>
										<button class="btn btn-muted btn-sm btn-icon" disabled="disabled"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
									<div class="form-group"><button class="btn btn-muted btn-xs" disabled="disabled">Extra Small</button>
										<button class="btn btn-muted btn-xs btn-icon" disabled="disabled"><svg width="16" height="16">
												<path d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3z
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" /></svg></button></div>
								</div>
							</div>
						...
						<div class="card-body card-body--padding--2">
							...
							<div class="row">
								<div class="col-lg-4">
									...
									<div class="form-group"><label>Default</label> <input type="text" class="form-control"
											placeholder="Placeholder"></div>
									<div class="form-group"><label>Readonly</label> <input type="text" class="form-control"
											placeholder="Placeholder" readonly="readonly"></div>
									<div class="form-group"><label>Disabled</label> <input type="text" class="form-control"
											placeholder="Placeholder" disabled="disabled"></div>
									<div class="form-group"><label>Success</label> <input type="text" class="form-control is-valid"
											placeholder="Placeholder">
										<div class="valid-feedback">Example invalid feedback text</div>
									</div>
									<div class="form-group"><label>Error</label> <input type="text" class="form-control is-invalid"
											placeholder="Placeholder">
										<div class="invalid-feedback">Example invalid feedback text</div>
									</div>
									<p class="mt-5"><strong>Text Field Sizes</strong></p>
									<div class="form-group"><input type="text" class="form-control form-control-lg" placeholder="Large">
									</div>
									<div class="form-group"><input type="text" class="form-control" placeholder="Normal"></div>
									<div class="form-group"><input type="text" class="form-control form-control-sm" placeholder="Small">
									</div>
								</div>
								<div class="col-lg-4">
									<p><strong>Select</strong></p>
									<div class="form-group"><label>Default</label> <select class="form-control">
											<option>Select</option>
										</select></div>
									<div class="form-group"><label>Disabled</label> <select class="form-control" disabled="disabled">
											<option>Select</option>
										</select></div>
									<div class="form-group"><label>Success</label> <select class="form-control is-valid">
											<option>Select</option>
										</select>
										<div class="valid-feedback">Example invalid feedback text</div>
									</div>
									<div class="form-group"><label>Error</label> <select class="form-control is-invalid">
											<option>Select</option>
										</select>
										<div class="invalid-feedback">Example invalid feedback text</div>
									</div>
									<p class="mt-5"><strong>Select Sizes</strong></p>
								...
								<div class="col-lg-4">
									...
									<div class="form-group"><label>Default</label> <textarea rows="3" class="form-control"
											placeholder="Placeholder"></textarea></div>
									<div class="form-group"><label>Readonly</label> <textarea rows="3" class="form-control"
											placeholder="Placeholder" readonly="readonly"></textarea></div>
									<div class="form-group"><label>Disabled</label> <textarea rows="3" class="form-control"
											placeholder="Placeholder" disabled="disabled"></textarea></div>
									<div class="form-group"><label>Success</label> <textarea rows="3" class="form-control is-valid"
											placeholder="Placeholder"></textarea></div>
									<div class="form-group"><label>Error</label> <textarea rows="3" class="form-control is-invalid"
											placeholder="Placeholder"></textarea></div>
									<p class="mt-5"><strong>Textarea Sizes</strong></p>
									<div class="form-group"><textarea rows="3" class="form-control form-control-lg"
											placeholder="Large"></textarea></div>
									<div class="form-group"><textarea rows="3" class="form-control" placeholder="Normal"></textarea></div>
									<div class="form-group"><textarea rows="3" class="form-control form-control-sm"
											placeholder="Small"></textarea></div>
								</div>
							</div>
						</div>
					</div>
					<div class="card mb-4">
						<div class="card-body card-body--padding--2">
							<h2 class="card-title">Select2</h2>
							<div class="row">
								<div class="col-lg-4">
									<p><strong>Disabled</strong></p>
									<div class="form-group"><select class="form-control form-control-select2" disabled="disabled">
									...
									<div class="form-group"><select class="form-control form-control-lg form-control-select2">
											<option>Select a country...</option>
											<option>United States</option>
											<option>Russia</option>
											<option>Italy</option>
									...
									<div class="form-group"><select class="form-control form-control-select2">
											<option>Select a country...</option>
											<option>United States</option>
											<option>Russia</option>
											<option>Italy</option>
									...
									<div class="form-group"><select class="form-control form-control-sm form-control-select2">
											<option>Select a country...</option>
											<option>United States</option>
											<option>Russia</option>
											<option>Italy</option>
					...
					<div class="card mb-4">
						<div class="card-body card-body--padding--2">
							<h2 class="card-title">Status Badge</h2>
							<div>
	...
	C2.3,8.2,2,7.4,2,6.5C2,4,4,2,6.5,2z M6.5,11c-0.9,0-1.7-0.3-2.4-0.7l6.2-6.2C10.7,4.8,11,5.6,11,6.5C11,9,9,11,6.5,11z" />
								...
								<div class="status-badge status-badge--style--warning status-badge--has-icon status-badge--has-text">
									<div class="status-badge__body">
										<div class="status-badge__icon"><svg width="13" height="13">
												<path d="M12,4.4L5.5,11L1,6.5l1.4-1.4l3.1,3.1L10.6,3L12,4.4z" /></svg></div>
										<div class="status-badge__text">On Order</div>
										<div class="status-badge__tooltip" tabindex="0" data-toggle="tooltip" title="On&#x20;Order"></div>
									</div>
								</div>
								<div class="status-badge status-badge--style--unknown status-badge--has-icon status-badge--has-text">
									<div class="status-badge__body">
										<div class="status-badge__icon"><svg width="13" height="13">
												<path
													d="M6.5,0C2.9,0,0,2.9,0,6.5S2.9,13,6.5,13S13,10.1,13,6.5S10.1,0,6.5,0z M6.5,2c0.9,0,1.7,0.3,2.4,0.7L2.7,8.9
	C2.3,8.2,2,7.4,2,6.5C2,4,4,2,6.5,2z M6.5,11c-0.9,0-1.7-0.3-2.4-0.7l6.2-6.2C10.7,4.8,11,5.6,11,6.5C11,9,9,11,6.5,11z" />
										...
										<div class="status-badge__text">Unknown</div>
										<div class="status-badge__tooltip" tabindex="0" data-toggle="tooltip" title="Unknown"></div>
									</div>
								</div>
							</div>
							<div class="mt-3">
							...
							<div class="mt-3">
								...
								<div class="status-badge status-badge--style--failure status-badge--has-icon">
									<div class="status-badge__body">
										<div class="status-badge__icon"><svg width="13" height="13">
												<path
													d="M6.5,0C2.9,0,0,2.9,0,6.5S2.9,13,6.5,13S13,10.1,13,6.5S10.1,0,6.5,0z M6.5,2c0.9,0,1.7,0.3,2.4,0.7L2.7,8.9
	C2.3,8.2,2,7.4,2,6.5C2,4,4,2,6.5,2z M6.5,11c-0.9,0-1.7-0.3-2.4-0.7l6.2-6.2C10.7,4.8,11,5.6,11,6.5C11,9,9,11,6.5,11z" />
								...
								<div class="status-badge status-badge--style--unknown status-badge--has-icon">
									<div class="status-badge__body">
										<div class="status-badge__icon"><svg width="13" height="13">
												<path
													d="M6.5,0C2.9,0,0,2.9,0,6.5S2.9,13,6.5,13S13,10.1,13,6.5S10.1,0,6.5,0z M6.5,2c0.9,0,1.7,0.3,2.4,0.7L2.7,8.9
	C2.3,8.2,2,7.4,2,6.5C2,4,4,2,6.5,2z M6.5,11c-0.9,0-1.7-0.3-2.4-0.7l6.2-6.2C10.7,4.8,11,5.6,11,6.5C11,9,9,11,6.5,11z" />
					...
					<div class="card">
						<div class="card-body card-body--padding--2">
							<h2 class="card-title">Tag Badge</h2>
							<div>
								<div class="tag-badge tag-badge--theme">Theme</div>
