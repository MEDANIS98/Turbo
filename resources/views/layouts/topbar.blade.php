...
<div class="header__topbar-start">
    <div class="topbar topbar--spaceship-start">
        ...
        <div class="topbar__item-text"><a class="topbar__link" href="{{ route('about') }}">@lang('About')</a></div>
        <div class="topbar__item-text"><a class="topbar__link" href="{{ route('contact') }}">@lang('Contact US')</a>
        </div>
        <div class="topbar__item-text"><a class="topbar__link" href="{{ route('track') }}">@lang('Track Order')</a>
        </div>
    </div>
</div>
...
<div class="header__topbar-end">
    <div class="topbar topbar--spaceship-end">
        ...
        <div class="topbar__item-button topbar__menu"><button
            ...
            <div class="topbar__menu-body"><a class="topbar__menu-item" href="#">€ Euro</a> <a class="topbar__menu-item"
                    href="#">£ Pound Sterling</a> <a class="topbar__menu-item" href="#">$ US
