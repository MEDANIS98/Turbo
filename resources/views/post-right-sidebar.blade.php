...
<head>
	...
	<title>Post Right Sidebar — Red Parts</title>
					...
					<div class="post-view__body">
						<div class="post-view__item post-view__item-post">
							...
							<div class="post-view__card post-navigation">
								<div class="post-navigation__body"><a class="post-navigation__item post-navigation__item--prev"
										href="#">
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" /></svg></span></a></li>
							...
							<div class="post-view__card">
								...
								<form class="post-view__card-body">
									<div class="form-row">
										<div class="form-group col-md-4"><label for="comment-first-name">First Name</label> <input
												type="text" class="form-control" id="comment-first-name" placeholder="First Name"></div>
										...
										<div class="form-group col-md-4"><label for="comment-email">Email Address</label> <input
												type="email" class="form-control" id="comment-email" placeholder="Email Address"></div>
									</div>
