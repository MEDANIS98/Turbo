...
<head>
	...
	<title>Header Classic Variant Three — Red Parts</title>
	...
	<link rel="stylesheet" href="css/style.header-classic-variant-three.css" media="(min-width: 1200px)">
...
<body>
	...
	C9.2,7.8,9.2,8.4,8.8,8.8z" /></svg></button>
		...
		<div class="site__body">
			...
			<div class="container text-center py-5 my-5 text-muted">Header classic variant three</div>
			<div class="block-space block-space--layout--divider-lg"></div>
		</div><!-- site__body / end -->
		<!-- site__footer -->
