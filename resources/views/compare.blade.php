							...
							<table class="compare__table compare-table">
								<tbody>
									<tr class="compare-table__row">
										...
										<td class="compare-table__column compare-table__column--product"><a href="#"
												class="compare-table__product">
												<div class="compare-table__product-image"><img src="images/products/product-1-150x150.jpg"
														alt=""></div>
												<div class="compare-table__product-name">Brandix Spark Plug Kit ASR-400</div>
											</a></td>
										<td class="compare-table__column compare-table__column--product"><a href="#"
												class="compare-table__product">
												<div class="compare-table__product-image"><img src="images/products/product-2-150x150.jpg"
														alt=""></div>
												<div class="compare-table__product-name">Brandix Brake Kit BDX-750Z370-S</div>
											</a></td>
										<td class="compare-table__column compare-table__column--product"><a href="#"
												class="compare-table__product">
												<div class="compare-table__product-image"><img src="images/products/product-3-150x150.jpg"
														alt=""></div>
												<div class="compare-table__product-name">Left Headlight Of Brandix Z54</div>
											</a></td>
										<td class="compare-table__column compare-table__column--product"><a href="#"
												class="compare-table__product">
												<div class="compare-table__product-image"><img src="images/products/product-4-150x150.jpg"
														alt=""></div>
												<div class="compare-table__product-name">Glossy Gray 19" Aluminium Wheel AR-19</div>
											</a></td>
										<td class="compare-table__column compare-table__column--product"><a href="#"
												class="compare-table__product">
												<div class="compare-table__product-image"><img src="images/products/product-5-150x150.jpg"
														alt=""></div>
