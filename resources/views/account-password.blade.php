...
<!-- Mirrored from red-parts.html.themeforest.scompiler.ru/themes/blue-ltr/account-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Feb 2020 19:35:30 GMT -->

<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width,initial-scale=1">
	<meta name="format-detection" content="telephone=no">
	<title>Account Password — Red Parts</title>
						...
						<div class="col-12 col-lg-3 d-flex">
							<div class="account-nav flex-grow-1">
								...
								<ul class="account-nav__list">
									...
									<li class="account-nav__item account-nav__item--active"><a href="account-password.html">Password</a>
									</li>
								...
								<div class="card-body card-body--padding--2">
									<div class="row no-gutters">
										<div class="col-12 col-lg-7 col-xl-6">
											<div class="form-group"><label for="password-current">Current Password</label> <input
													type="password" class="form-control" id="password-current" placeholder="Current Password">
											</div>
											<div class="form-group"><label for="password-new">New Password</label> <input type="password"
													class="form-control" id="password-new" placeholder="New Password"></div>
											<div class="form-group"><label for="password-confirm">Reenter New Password</label> <input
													type="password" class="form-control" id="password-confirm" placeholder="Reenter New Password">
											</div>
											<div class="form-group mb-0"><button class="btn btn-primary mt-3">Change</button></div>
										</div>
									</div>
								</div>
							</div>
