...
<head>
	...
	<title>Header Spaceship Variant Two — Red Parts</title>
	...
	<link rel="stylesheet" href="css/style.header-spaceship-variant-two.css" media="(min-width: 1200px)">
...
>>>>>>> 209187adbb27d6dd30f9b6e104fd17bafb9c612d
	...
	C9.2,7.8,9.2,8.4,8.8,8.8z" /></svg></button>
		...
		<div class="site__body">
			...
			<div class="container text-center py-5 my-5 text-muted">Header spaceship variant two</div>
			<div class="block-space block-space--layout--divider-lg"></div>
		</div><!-- site__body / end -->
		<!-- site__footer -->
