        ...
        <div class="block-teammates__list">
            <div class="owl-carousel">
                <div class="block-teammates__item teammate">
                    <div class="teammate__avatar"><img src="/images/teammates/teammate1-206x206.jpg"
                            alt="@lang('Photo')">
                    </div>
                ...
                <div class="block-teammates__item teammate">
                    <div class="teammate__avatar"><img src="/images/teammates/teammate2-206x206.jpg"
                            alt="@lang('Photo')">
                    </div>
                    <div class="teammate__info">
                ...
                <div class="block-teammates__item teammate">
                    <div class="teammate__avatar"><img src="/images/teammates/teammate3-206x206.jpg"
                            alt="@lang('Photo')">
                    </div>
                    <div class="teammate__info">
                ...
                <div class="block-teammates__item teammate">
                    <div class="teammate__avatar"><img src="/images/teammates/teammate4-206x206.jpg"
                            alt="@lang('Photo')">
                    </div>
                    <div class="teammate__info">
                ...
                <div class="block-teammates__item teammate">
                    <div class="teammate__avatar"><img src="/images/teammates/teammate5-206x206.jpg"
                            alt="@lang('Photo')">
                    </div>
                    <div class="teammate__info">
