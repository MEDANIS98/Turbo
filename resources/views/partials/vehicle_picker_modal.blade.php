...
<div id="vehicle-picker-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	...
	C11.2,9.8,11.2,10.4,10.8,10.8z" /></svg></button>
			...
			<div class="vehicle-picker-modal__panel" data-panel="form">
				...
				<div class="vehicle-picker-modal__actions"><button type="button" class="btn btn-sm btn-secondary" data-to-panel="list">Back to list</button> <button type="button" class="btn btn-sm btn-primary">Add A
						Vehicle</button></div>
			</div>
		</div>
	</div>
