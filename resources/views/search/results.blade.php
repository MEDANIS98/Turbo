												...
												<div class="filter__container">
													<div class="filter-vehicle">
														<ul class="filter-vehicle__list">
															...
															<li class="filter-vehicle__item"><label class="filter-vehicle__item-label"><span class="filter-list__input input-radio"><span class="input-radio__body"><input class="input-radio__input" name="filter_vehicle" type="radio" checked="checked"> <span class="input-radio__circle"></span>
												...
												<div class="filter__container">
													<div class="filter-list">
														<div class="filter-list__list"><label class="filter-list__item"><span class="input-check filter-list__input"><span class="input-check__body"><input class="input-check__input" type="checkbox">
															...
															<label class="filter-list__item filter-list__item--disabled"><span class="input-check filter-list__input"><span class="input-check__body"><input class="input-check__input" type="checkbox" checked="checked" disabled="disabled"> <span class="input-check__box"></span>
																		<span class="input-check__icon"><svg width="9px" height="7px">
																				<path d="M9,1.395L3.46,7L0,3.5L1.383,2.095L3.46,4.2L7.617,0L9,1.395Z" />
																			</svg>
							...
							<div class="card widget widget-products d-none d-lg-block">
								...
								<div class="widget-products__list">
									<div class="widget-products__item">
										<div class="widget-products__image"><a href="product-full.html"><img src="images/products/product-1-64x64.jpg" alt=""></a>
										</div>
									...
									<div class="widget-products__item">
										<div class="widget-products__image"><a href="product-full.html"><img src="images/products/product-2-64x64.jpg" alt=""></a>
										</div>
										<div class="widget-products__info">
									...
									<div class="widget-products__item">
										<div class="widget-products__image"><a href="product-full.html"><img src="images/products/product-3-64x64.jpg" alt=""></a>
										</div>
										<div class="widget-products__info">
									...
									<div class="widget-products__item">
										<div class="widget-products__image"><a href="product-full.html"><img src="images/products/product-4-64x64.jpg" alt=""></a>
										</div>
										<div class="widget-products__info">
									...
									<div class="widget-products__item">
										<div class="widget-products__image"><a href="product-full.html"><img src="images/products/product-5-64x64.jpg" alt=""></a>
										</div>
										<div class="widget-products__info">
