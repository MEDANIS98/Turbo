                    ...
                    <div class="block">
                        <div class="categories-list categories-list--layout--columns-4-sidebar">
                            <ul class="categories-list__body">
                                <li class="categories-list__item"><a href="#"><img
                                            src="images/categories/category-1-200x200.jpg" alt="">
                                ...
                                <li class="categories-list__item"><a href="#"><img
                                            src="images/categories/category-2-200x200.jpg" alt="">
                                ...
                                <li class="categories-list__divider"></li>
                                <li class="categories-list__item"><a href="#"><img
                                            src="images/categories/category-3-200x200.jpg" alt="">
                                ...
                                <li class="categories-list__divider"></li>
                                <li class="categories-list__item"><a href="#"><img
                                            src="images/categories/category-4-200x200.jpg" alt="">
                                ...
                                <li class="categories-list__divider"></li>
                                <li class="categories-list__item"><a href="#"><img
                                            src="images/categories/category-5-200x200.jpg" alt="">
                                ...
                                <li class="categories-list__divider"></li>
                                <li class="categories-list__item"><a href="#"><img
                                            src="images/categories/category-6-200x200.jpg" alt="">
                                ...
                                <li class="categories-list__divider"></li>
                                <li class="categories-list__item"><a href="#"><img
                                            src="images/categories/category-7-200x200.jpg" alt="">
                                ...
                                <li class="categories-list__divider"></li>
                                <li class="categories-list__item"><a href="#"><img
                                            src="images/categories/category-8-200x200.jpg" alt="">
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" /></svg></button> <button
                                                ...
                                                <div class="product-card__info">
                                                    <div class="product-card__meta"><span
                                                        ...
                                                        855-78336-G</div>
                                                    <div class="product-card__name">
                                                        <div><a href="product-full.html">Brandix Manual Five Speed
                                                                Gearbox</a></div>
                                                    </div>
                                                    <div class="product-card__rating">
                                                        <div class="rating product-card__rating-stars">
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" /></svg></button> <button
                                                ...
                                                <div class="product-card__info">
                                                    <div class="product-card__meta"><span
                                                        ...
                                                        473-75662-R</div>
                                                    <div class="product-card__name">
                                                        <div><a href="product-full.html">Set of Car Floor Mats Brandix
                                                                Z4</a></div>
                                                    </div>
                                                    <div class="product-card__rating">
                                                        <div class="rating product-card__rating-stars">
                        ...
                        <div class="container">
                            <ul class="block-brands__list">
                                <li class="block-brands__item"><a href="#" class="block-brands__item-link"><img
                                            ...
                                            class="block-brands__item-name">AimParts</span></a>
                                </li>
                                ...
                                <li class="block-brands__item"><a href="#" class="block-brands__item-link"><img
                                            ...
                                            class="block-brands__item-name">StartOne</span></a>
                                </li>
                                <li class="block-brands__divider" role="presentation"></li>
                                <li class="block-brands__item"><a href="#" class="block-brands__item-link"><img
                                ...
                                <li class="block-brands__item"><a href="#" class="block-brands__item-link"><img
                                            ...
                                            class="block-brands__item-name">JustRomb</span></a>
                                </li>
                                <li class="block-brands__divider" role="presentation"></li>
                                <li class="block-brands__item"><a href="#" class="block-brands__item-link"><img
                                ...
                                <li class="block-brands__item"><a href="#" class="block-brands__item-link"><img
                                            ...
                                            class="block-brands__item-name">RedGate</span></a>
                                </li>
                                <li class="block-brands__divider" role="presentation"></li>
                                <li class="block-brands__item"><a href="#" class="block-brands__item-link"><img
                        ...
                        <div class="widget-categories-list__body" data-collapse
                            ...
                            <ul class="widget-categories-list__root">
                                <li class="widget-categories-list__root-item widget-categories-list__root-item--has-children"
                                    data-collapse-item><a href="#" class="widget-categories-list__root-link">Headlights
                                        & Lighting</a>
                                    ...
                                    </ul><button type="button" class="widget-categories-list__show-more"
                                        data-collapse-trigger><span
                                            class="widget-categories-list__show-more-expand-text">Show More</span> <span
                                            class="widget-categories-list__show-more-collapse-text">Show Less</span>
                                ...
                                <li class="widget-categories-list__root-item widget-categories-list__root-item--has-children"
                                    data-collapse-item><a href="#" class="widget-categories-list__root-link">Interior
                                        Parts</a>
                                    <ul class="widget-categories-list__child">
                                        <li class="widget-categories-list__child-item"><a href="#"
                                        ...
                                        <li class="widget-categories-list__child-item"><a href="#"
                                                class="widget-categories-list__child-link">Consoles & Organizers</a>
                                        </li>
                                        <li class="widget-categories-list__child-item"><a href="#"
                                ...
                                <li class="widget-categories-list__root-item widget-categories-list__root-item--has-children"
                                    data-collapse-item><a href="#" class="widget-categories-list__root-link">Engine &
                                        Drivetrain</a>
                                    <ul class="widget-categories-list__child">
                                        <li class="widget-categories-list__child-item"><a href="#"
                        ...
                        <div class="widget-products__list">
                            <div class="widget-products__item">
                                ...
                                <div class="widget-products__info">
                                    <div class="widget-products__name"><a href="product-full.html">Brandix Spark Plug
                                            Kit ASR-400</a>
                                    </div>
                            ...
                            <div class="widget-products__item">
                                ...
                                <div class="widget-products__info">
                                    ...
                                    <div class="widget-products__prices">
                                        <div class="widget-products__price widget-products__price--current">$224.00
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="widget-products__item">
                                ...
                                <div class="widget-products__info">
                                    <div class="widget-products__name"><a href="product-full.html">Left Headlight Of
                                            Brandix Z54</a>
                                    </div>
                                    <div class="widget-products__prices">
                            ...
                            <div class="widget-products__item">
                                ...
                                <div class="widget-products__info">
                                    <div class="widget-products__name"><a href="product-full.html">Glossy Gray 19"
                                            Aluminium Wheel
                                            AR-19</a></div>
                                    <div class="widget-products__prices">
                                        <div class="widget-products__price widget-products__price--current">$589.00
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="widget-products__item">
                                ...
                                <div class="widget-products__info">
                                    <div class="widget-products__name"><a href="product-full.html">Twin Exhaust Pipe
                                            From Brandix
                                            Z54</a></div>
                                    <div class="widget-products__prices">
                                        <div class="widget-products__price widget-products__price--current">$749.00
                                        </div>
                                    </div>
                                </div>
                            </div>
