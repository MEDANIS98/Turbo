...
<!-- Mirrored from red-parts.html.themeforest.scompiler.ru/themes/blue-ltr/account-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Feb 2020 19:35:30 GMT -->

<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width,initial-scale=1">
	<meta name="format-detection" content="telephone=no">
	<title>Account Dashboard — Red Parts</title>
						...
						<div class="col-12 col-lg-3 d-flex">
							<div class="account-nav flex-grow-1">
								...
								<ul class="account-nav__list">
									<li class="account-nav__item account-nav__item--active"><a href="account-dashboard.html">Dashboard</a>
									</li>
							...
							<div class="dashboard">
								<div class="dashboard__profile card profile-card">
									<div class="card-body profile-card__body">
										<div class="profile-card__avatar"><img src="images/avatars/avatar-4.jpg" alt=""></div>
