        ...
        <div class="not-found">
            ...
            <div class="not-found__content">
                ...
                <form class="not-found__search">
                    <input type="text" class="not-found__search-input form-control"
                        placeholder="@lang('Search Query...')"> <button type="submit"
                        class="not-found__search-button btn btn-primary">@lang('Search')</button>
                </form>
